...
class SR4KDataset(data.Dataset):
    '''
    Reading the training sr4k dataset
    key example: 000_00000000
    GT: Ground-Truth;
    LQ: Low-Quality, low-resolution frames
    support reading N LQ frames, N = 1, 3, 5, 7
    '''

    def __init__(self, opt):
        super(SR4KDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        if self.data_type == 'mc':
            ...
            img_GT = util.read_img(self.GT_env, '{}_{}'.format(name_a, name_b), (3, 1080, 1920))
        else:
